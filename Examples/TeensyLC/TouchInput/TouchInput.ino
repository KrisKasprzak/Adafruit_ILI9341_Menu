...
// you know the drill
ILI9488_t3 Display(CS_PIN, DC_PIN, 8); //Display object
...
void setup() {
  ...
  if (sd.begin(17, SD_SCK_MHZ(20))) {

    Serial.println("sdfat OK");
  }
  else {
    Serial.println("sdfat fucked");
...
void ProcessTouch() {
  ...
  BtnX  = map(BtnX, 3900, 175, 0, 480);
  BtnY  = map(BtnY, 3950, 200, 0, 320);
